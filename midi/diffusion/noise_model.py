...
from midi.datasets.pharmacophore_utils import prepare_pharma_data
...
class NoiseModel:
    ...
    def apply_noise(self, dense_data):
        ...
        z_t = utils.PlaceHolder(X=X_t, charges=charges_t, E=E_t, y=dense_data.y, pos=pos_t, t_int=t_int,
                                ...
                                pharma_atom_pos=dense_data.pharma_atom_pos).mask()
        return z_t
    ...
    def sample_limit_dist(self,data, node_mask, sample_condition, n_nodes):
        ...
        pharma_coord = pharma_coord * pharma_mask.unsqueeze(-1)
        pharma_feat = pharma_feat * pharma_mask.unsqueeze(-1)
        pharma_atom = pharma_atom * pharma_mask.unsqueeze(-1)
        pharma_atom_pos = pharma_atom_pos * pharma_mask.unsqueeze(-1)
        ...
        return utils.PlaceHolder(X=U_X, charges=U_c, E=U_E, y=U_y, pos=pos, t_int=t_int_array, t=t_array,
                                 ...
                                 pharma_atom_pos=pharma_atom_pos).mask(node_mask)
    ...
    def sample_zs_from_zt_and_pred(self, z_t, pred, s_int):
        ...
        z_s = utils.PlaceHolder(X=X_s, charges=charges_s,
                                ...
                                pharma_atom_pos=pred.pharma_atom_pos).mask(node_mask)
        return z_s
