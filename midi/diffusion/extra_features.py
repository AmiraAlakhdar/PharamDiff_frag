...
class ExtraFeatures:
    ...
    def __call__(self, z_t):
        ...
        y = z_t.y
        charges = z_t.charges
        pharma_coord = z_t.pharma_coord
        pharma_feat = z_t.pharma_feat
        pharma_atom = z_t.pharma_atom
        pharma_atom_pos = z_t.pharma_atom_pos
        if self.features_type is None:
            ...
            empty_pharma_feat= pharma_feat.new_zeros((*pharma_feat.shape[:-1], 0))
            empty_pharma_coord= pharma_coord.new_zeros((*pharma_coord.shape[:-1], 0))
            empty_pharma_atom = pharma_atom.new_zeros((*X.shape[:-1], 0))
            empty_pharma_atom_pos = pharma_atom_pos.new_zeros((*X.shape[:-1], 0))
            return utils.PlaceHolder(X=empty_x, charges=empty_charges, E=empty_e, y=empty_y, pos=empty_pos, 
                                     pharma_feat=empty_pharma_feat, pharma_coord=empty_pharma_coord, 
                                     pharma_atom=empty_pharma_atom, pharma_atom_pos=empty_pharma_atom_pos)  
            ...
            empty_pharma_feat= pharma_feat.new_zeros((*pharma_feat.shape[:-1], 0))
            empty_pharma_coord= pharma_coord.new_zeros((*pharma_coord.shape[:-1], 0))
            empty_pharma_atom = pharma_atom.new_zeros((*pharma_atom.shape[:-1], 0))
            empty_pharma_atom_pos = pharma_atom_pos.new_zeros((*pharma_atom_pos.shape[:-1], 0))
